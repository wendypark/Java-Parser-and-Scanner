...
public class Parser {
    ...
    private class SymbolTable {   
        ...
        // Declare Variables with a pointer to it to manage E's scoping operator
        ...
        private void addVarHelper(String var_name, Boolean withPrint) {
        ...
        public void addVar(String var_name) {
            addVarHelper(var_name, true);
        }

        // Add variable but don't print the declaration
        public void addVar_no_print(String var_name) {
            addVarHelper(var_name, false);
        }
    ...
    private void declare_and_assign(){
        ...
        mustis(TK.ID);
        symTable.addVar_no_print(tok.string);
